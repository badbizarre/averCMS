...
<div class="row">
	...
	<div class="modal fade bs-example-modal-lg" id="dialog-tree-edit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<form method="POST" class="form-horizontal" role="form_tree" action="<?php echo get_url_admin_form(2).'/edit_tree'; ?>" target="hiddenframe" enctype="multipart/form-data">
						...
						<div class="tab-content">
							...
							<div class="row">
								<div class="col-sm-10">
									...
									<?php echo html_form_image_crop(@$image,'catalog_tree'); ?>
